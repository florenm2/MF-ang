...
angular.module('adminlogin.reset', ['security.service', 'services.utility', 'ui.bootstrap']);
angular.module('adminlogin.reset').config(['$routeProvider', function($routeProvider){
  $routeProvider
    .when('/admin/login/reset', {
      templateUrl: 'adminlogin/reset/adminlogin-reset.tpl.html',
      controller: 'AdminLoginResetCtrl',
      title: 'Reset Your Password'
    })
    .when('/admin/login/reset/:email/:token', {
      templateUrl: 'adminlogin/reset/adminlogin-reset.tpl.html',
      controller: 'AdminLoginResetCtrl'
    });
}]);
angular.module('adminlogin.reset').controller('AdminLoginResetCtrl', [ '$scope', '$location', '$routeParams', '$log', 'security', 'utility',
