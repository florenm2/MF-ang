...
var adminPH = require('./service/admin/purchase-history');
...
exports = module.exports = function(app, passport) {
  ...
  app.get('/api/getProducts', products.getAllProducts);
  ...
  app.get('/api/account/getOnePurchaseHistory', purchaseHistory.getOnePurchaseHistory);
  
  app.put('/api/account/settings/mailingAddress', address.update); 
  ...
  app.get('/api/admin/accounts/:id/purchases', adminAccount.purchaseHistory);
  ...
  app.put('/api/admin/purchase-history/:id', adminPH.update);
  app.delete('/api/admin/purchase-history/:id', adminPH.delete);

  //admin > products
  app.get('/api/admin/pricing', adminProduct.find);
  app.post('/api/admin/pricing/', adminProduct.create);
  app.get('/api/admin/pricing/:id', adminProduct.read);
  app.put('/api/admin/pricing/:id', adminProduct.update);
  app.delete('/api/admin/pricing/:id', adminProduct.delete);
  ...
  //admin > sales
  app.get('/admin/sales', useAngular);

  //admin > purchase history
  app.get('/admin/purchase-history', useAngular);
