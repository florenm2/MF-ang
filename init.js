  ...
  async.waterfall([
    ...
    function(content, cb){
      ...
      var map = {
        ...
        '{{SMTP_EMAIL}}': smtpEnabled? workflow.smtp.email: 'SafeConnectContact@gmail.com',
        '{{SMTP_PASSWORD}}': smtpEnabled? workflow.smtp.password: 'SCcontact',
        '{{SMTP_HOST}}': smtpEnabled? workflow.smtp.host: 'smtp-pulse.com'
